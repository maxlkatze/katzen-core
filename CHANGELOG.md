...
- Simplified image storage paths for improved clarity ([8ec29f1](https://github.com/maxlkatze/katzen-core/commit/8ec29f1))
...
[compare changes](https://github.com/maxlkatze/katzen-core/compare/v0.0.81...v0.0.82)
...
- Update connector usage to improve code clarity in ContentStorage (master) ([ac8fba0](https://github.com/maxlkatze/katzen-core/commit/ac8fba0))
...
- Add upload and download functionality for site configuration (master) ([7e07d1e](https://github.com/maxlkatze/katzen-core/commit/7e07d1e))
...
- Added lifecycle handler and token validation (master) ([26dbd34](https://github.com/maxlkatze/katzen-core/commit/26dbd34))

### 🏡 Chore

- **release:** V0.0.68 ([2706a2d](https://github.com/maxlkatze/katzen-core/commit/2706a2d))
