...
export const useKatzeCustomComponent = (options: CustomComponentDefinition) => {
  ...
  if (options.isArray) {
    ...
    const defaultArrayValue: CustomComponentArrayValue = Array.isArray(options.default) 
      ? options.default as Record<string, any>[]
      : options.default 
        ? [options.default as Record<string, any>]
    ...
    const defaultValue: Record<string, any> = (options.default as Record<string, any>) || generateDefaultAttributes(options.schema)
...
function generateDefaultAttributes(schema: Record<string, { type: string, arrayItemType?: string, default: any }>): Record<string, any> {
